...
// export function sendOnDebug(func: IExecuteFunctions, message: any, messageHeader: string = ""){
// 	if (['verbose', 'debug'].includes(process.env.N8N_LOG_LEVEL as string)) {
// 		if (messageHeader) func.sendMessageToUI(messageHeader)
// 			func.sendMessageToUI(message)
// 	}
// }
